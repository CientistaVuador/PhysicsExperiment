 ...
 * @author Cien
 */
public class DynamicPlayerController {
    ...
    private final DynamicCharacterController characterController;
    ...
    public DynamicPlayerController() {
        this.characterController = new DynamicCharacterController(RADIUS, HEIGHT, CROUCH_HEIGHT, MASS);
    }

    public DynamicCharacterController getCharacterController() {
